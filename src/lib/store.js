...
export const STATUS = {
  ...
  // 순위 글에서 대상이 실제로 몇 개 있는지 세는 단계.
  // ("TOP 50" 인데 26개뿐이면 26개로 줄을 세워야 하기 때문에 글쓰기보다 먼저 한다)
  CENSUS: 'census',
  WRITING: 'writing',
  CHECKING: 'checking',
  THUMBNAIL: 'thumbnail',
...
const RUNNING_STATUSES = [
  STATUS.RESEARCHING, STATUS.CENSUS, STATUS.WRITING, STATUS.CHECKING,
  STATUS.THUMBNAIL, STATUS.POSTING,
];
